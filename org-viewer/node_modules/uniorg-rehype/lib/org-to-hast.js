        ...
        switch (org.type) {
            ...
            case 'headline': {
                ...
                const tags = org.tags.length
                    ...
                    : null;
                return h(org, `h${org.level}`, {}, [todo, priority, ...toHast(org.children, org), tags].filter(notNull));
            }
...
function stripCommonIndent(element, commonIndent) {
